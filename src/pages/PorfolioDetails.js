...
const ProjectDetails = () => {
  ...
  const {
    ...
    fetch(`https://rana-arju.onrender.com/project/${id}`, {
      method: "GET",
      headers: {
  ...
  return (
    <div>
      ...
      <h2 className="text-center text-xl md:text-4xl capitalize font-bold my-10">
        More Project <span className="cl-title">images</span>
      </h2>
